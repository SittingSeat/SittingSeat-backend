package com.sittingseat.sittingseat.security;
...
import com.sittingseat.sittingseat.repository.RefreshTokenRepository;
...
public class JwtTokenProvider {
    ...
    public Authentication getAuthentication(String accessToken) {
        ...
        if (claims.get("auth") == null) {
            throw new SittingSeatException(SittingSeatErrorCode.UNAUTHORIZED_TOKEN);
        }
    ...
    public boolean validateToken(String token) {
        try {
            ...
            throw new SittingSeatException(SittingSeatErrorCode.INVALID_TOKEN);
        } catch (UnsupportedJwtException e) {
            log.info("Unsupported JWT Token", e);
            throw new SittingSeatException(SittingSeatErrorCode.UNSUPPORTED_TOKEN);
        } catch (IllegalArgumentException e) {
            log.info("JWT claims string is empty.", e);
            throw new SittingSeatException(SittingSeatErrorCode.EMPTY_CLAIM_TOKEN);
        } catch (ExpiredJwtException e){
            log.error("Expired JWT Token", e);
            throw new SittingSeatException(SittingSeatErrorCode.EXPIRED_TOKEN);
        }
    }
